      ...
      <div className="relative">
        {showFilter && (
          <div
            ...
            <h4 className="font-medium mb-3">Filter Applications</h4>
          ...
          <tbody>
            ...
            {paginated.map((a) => (
              <tr key={a._id} className="border-t">
                ...
                <td className="p-3">{a.artFormName}</td>
      ...
      {viewApplication && (
        <div className="fixed inset-0 soft-blur flex items-center justify-center z-50 px-4">
          <div
            ...
            ref={modalRef}>
            {/* Header with Brand Color Overlay */}
            <div className="bg-[#83261D] p-6 text-white relative">
              ...
              <div className="flex flex-col gap-1">
                <h2 className="text-2xl font-bold">{viewApplication.name}</h2>
                <div className="mt-2 inline-flex items-center w-fit px-3 py-1 bg-white/20 rounded-lg text-sm">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 p-3 rounded-xl border border-gray-100">
                  <p className="text-[10px] text-gray-500 uppercase font-bold mb-1 tracking-tight">
                    Age
                  </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-red-50 flex items-center justify-center text-[#83261D] shrink-0">
                    <svg
