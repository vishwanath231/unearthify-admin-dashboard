      ...
      <div className="relative">
        {showFilter && (
          <div
            ...
            <h4 className="font-medium text-sm sm:text-base mb-2 sm:mb-3">Filter Event Applications</h4>
        ...
        <div className="fixed inset-0 bg-black/20 backdrop-blur-sm flex items-center justify-center z-50 p-3 sm:p-4">
          <div
            ...
            <div className="bg-[#83261D] p-4 sm:p-5 md:p-6 text-white relative">
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col mt-1 sm:mt-2">
                  <span className="text-[10px] sm:text-xs text-white/60 font-bold ml-1 mb-0.5">
                    Event
                  </span>
                ...
                <div className="flex flex-col mt-1">
                  ...
                  <span className="inline-flex w-fit px-2 sm:px-3 py-0.5 sm:py-1 bg-white/10 rounded-lg text-xs sm:text-sm font-medium border border-white/5">
            ...
            <div className="p-4 sm:p-5 md:p-6 space-y-4 sm:space-y-5 md:space-y-6">
              ...
              <div className="flex items-center justify-between bg-gray-50 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gray-100">
                <div className="text-center flex-1 border-r border-gray-200">
                  <p className="text-[8px] sm:text-[9px] md:text-[10px] text-gray-400 uppercase font-bold tracking-wider">
                    Age
                  </p>
              ...
              <div className="space-y-3 sm:space-y-4 md:space-y-5">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-lg sm:rounded-xl bg-red-50 flex items-center justify-center text-[#83261D] shrink-0 border border-red-100">
                    <svg
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[9px] sm:text-[10px] md:text-xs text-gray-400 font-bold uppercase tracking-wide">
                      Phone Number
                    </p>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-600 text-xs sm:text-sm leading-relaxed text-justify break-words max-h-24 sm:max-h-32 overflow-y-auto">
